...
let d = new Date();
    //Umständlich und kompliziert, aber in manchen Situationen will man nur das Jahr verändern, oder den Monat etc
d.setFullYear(1993);
d.setMonth(0);
d.setDate(16);
d.setHours(9);
...
d.setMilliseconds(111);
    ...
    // Analog zu den setter-Methoden gibt es auch die getter-Methoden
